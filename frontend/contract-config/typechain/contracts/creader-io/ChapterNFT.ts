...
export interface ChapterNFTInterface extends utils.Interface {
  functions: {
    ...
    "createChapter(string,string)": FunctionFragment;
    ...
    "updateChapter(uint256,string)": FunctionFragment;
  };
  ...
  encodeFunctionData(
    functionFragment: "createChapter(string,string)",
    values: [PromiseOrValue<string>, PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "updateChapter",
    values: [PromiseOrValue<BigNumberish>, PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
    functionFragment: "updateChapter(uint256,string)",
    values: [PromiseOrValue<BigNumberish>, PromiseOrValue<string>]
  ): string;
...
export interface ChapterNFT extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ChapterNFTInterface;
  ...
  functions: {
    ...
    chapters(
      ...
      overrides?: CallOverrides
    ): Promise<[string, string] & { title: string; owner: string }>;
