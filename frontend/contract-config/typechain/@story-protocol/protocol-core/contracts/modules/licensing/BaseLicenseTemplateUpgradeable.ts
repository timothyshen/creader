...
export interface BaseLicenseTemplateUpgradeableInterface
...
export interface BaseLicenseTemplateUpgradeable extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BaseLicenseTemplateUpgradeableInterface;
