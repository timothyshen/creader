...
export interface MockERC721SecondInterface extends utils.Interface {
  functions: {
...
export interface MockERC721Second extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MockERC721SecondInterface;
